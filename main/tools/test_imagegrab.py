    ...
    while True:
        ...
        if found_active_character:
            ...
            if loop_count % OCR_CHARNAMES_ONE_IN == 0 or len([a for a in curr_char_names if a == ""]) > 0:
                ...
                char_results = [[((0,0,0,0), pytesseract.image_to_string(img, config=f'--psm 6 -c tessedit_char_whitelist={ALLOWLIST}'), 1.0)] for img in charname_cap]
            ...
            if loop_count % OCR_LOC_ONE_IN == 0:
                ...
                loc_results = [[((0,0,0,0), pytesseract.image_to_string(loc_cap, config=f'--psm 6 -c tessedit_char_whitelist={ALLOWLIST}'), 1.0)]]
            ...
            if loop_count % OCR_BOSS_ONE_IN == 0:
                ...
                boss_results = [[((0,0,0,0), pytesseract.image_to_string(boss_cap, config=f'--psm 6 -c tessedit_char_whitelist={ALLOWLIST}'), 1.0)]]
            ...
            party_results = [[((0,0,0,0), pytesseract.image_to_string(party_cap, config=f'--psm 6 -c tessedit_char_whitelist={ALLOWLIST}'), 1.0)]]
            ...
            if domain_cooldown == 0:
                ...
                domain_results = [[((0,0,0,0), pytesseract.image_to_string(domain_cap, config=f'--psm 6 -c tessedit_char_whitelist={ALLOWLIST}'), 1.0)]]
